...
<body>
    ...
    <h1>Fork Resep</h1>
    <h3>{{ $data->nama.' oleh '.$data->user_id }}</h3>
        <form action="{{ route('insertFork') }}" method="post" enctype="multipart/form-data" id="submitResep">
            @csrf
            ...
            <div class="col rounded-pill d-flex align-items-center w-100 h-100 mb-3"
                ...
                <div class="w-100 py-4 px-4">
                    <input name="nama" type="text" class="form-control p-0" placeholder="Nama Resep"
                        ...
                        style="background-color: #FCF1F1; box-shadow: none; border: 0px solid;" value="{!! $data->nama !!}">
                </div>
            </div>
            <div class="col rounded-pill d-flex align-items-center w-100 h-100 mb-3"
                style=" background: #FCF1F1; border: 1px solid #BC1823;">
                <div class="w-100 py-4 px-4">
                    <input name="waktu" type="number" class="form-control p-0" placeholder="Total Waktu memasak"
                        aria-describedby="button-addon2"
                        style="background-color: #FCF1F1; box-shadow: none; border: 0px solid;" value={!! $data->waktu !!}>
                </div>
            </div>
            <div class="col rounded-5 d-flex align-items-center w-100 h-100 mb-3"
                ...
                <div class="row w-100 ps-4">
                    ...
                    <div class="collapse pb-3 px-0" id="collapseExample">
                        <textarea name="bahan" class="form-control" id="exampleFormControlTextarea1" rows="10">{{ str_replace(";", "\n", $data->bahan) }}</textarea>
                    </div>
                </div>
            </div>
            <div class="col rounded-5 d-flex align-items-center w-100 h-100 mb-3"
                ...
                <div class="row w-100 ps-4">
                    ...
                    <div class="collapse pb-3 px-0" id="collapseExample2">
                        <textarea name="alat" class="form-control" id="exampleFormControlTextarea1" rows="10">{{ str_replace(";", "\n", $data->alat) }}</textarea>
                    </div>
                </div>
            </div>
            <div class="col rounded-5 d-flex align-items-center w-100 h-100 mb-3"
                ...
                <div class="row w-100 ps-4">
                    ...
                    <div class="collapse pb-3 px-0" id="collapseExample3">
                        <textarea name="langkah" class="form-control" id="exampleFormControlTextarea1" rows="10">{{ str_replace(";", "\n", $data->langkah) }}</textarea>
                    </div>
                </div>
            </div>
            <div class="col rounded-pill d-flex align-items-center w-100 h-100 mb-3"
