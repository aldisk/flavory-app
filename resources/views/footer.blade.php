        ...
        <footer class="d-flex justify-content-center row row-cols-1 row-cols-sm-1 row-cols-md-5 py-3 border-top">
            <div class="col mb-3 d-inline-block">
                <a href="/" class="d-flex justify-content-start link-body-emphasis text-decoration-none">
                    <img src="{{ asset('img/flavory-removebg-preview.png') }}" alt="Logo" width="150"
                        class="d-inline-block align-text-center">
                </a>
                <div class="d-inline-block">
                    <p>Daftar dan eksplor resep kesukaanmu</p>
            ...
            <div class="col mb-3 pt-4">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="/about-us" class="nav-link p-0 text-body-secondary">Meet The Team</a></li>
                </ul>
            </div>
            ...
            <div class="col mb-3 pt-4">
                <h5>Features</h5>
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="/resep/search" class="nav-link p-0 text-body-secondary">Recipe</a></li>
                    <li class="nav-item mb-2"><a href="/resep/insert" class="nav-link p-0 text-body-secondary">Add yours</a>
                    </li>
                </ul>
            </div>
